...
import running from '@/assets/features/running.jpg'
import soles from '@/assets/features/soles.jpg'
import award from '@/assets/features/award.webp'
...
const DesktopFeatures = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-6">
            <h1 className="rounded-xl bg-light p-5 text-2xl font-bold tracking-wider dark:bg-gray-800 lg:text-3xl">
                {t('features-heading')}
            </h1>
